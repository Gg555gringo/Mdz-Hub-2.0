if game.PlaceId == 2753915549 or game.PlaceId == 4442272183 or game.PlaceId == 7449423635 then
  ...
  elseif placeId == 7449423635 then
      ...
      local sxhub = library:AddWindow("MdzHub | Bloxfruit!",Enum.KeyCode.RightControl)
  ...
  for i,v in pairs(game.workspace.Enemies:GetChildren()) do
    ...
    local SelectWeapon = Main:AddDropdown("Select Weapon", Wapon,function(vu)
      ...
      for i,v in pairs(game.workspace.Enemies:GetChildren()) do
       ...
       Main:AddSeperator("Farm Select Boss")   
  MiscFarmWeapon = ""
  if Old_World then
  ...
  elseif New_World then
      tp:AddButton("TP Sea1",function()
          game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelMain")
      end)
      tp:AddButton("TP Sea3",function()
          game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelZou")
      end)
      Main:AddLabel("Novo Mundo")
      tp:AddButton("Dock",function()
          TP2(CFrame.new(-12.519311904907, 19.302536010742, 2827.853515625))
      end)
      tp:AddButton("Mansão",function()
  ...
  elseif Three_World then
    raid:AddButton("Teleport to Lab",function()
      ...
      raid:AddToggle("Auto Raid",false,function(vu)
      _G.AutoRaid = vu
      AutoAwakener = vu
      Killaura = vu
      AutoBuychip = vu
  ...
  set:AddLabel("Setting")
      set:AddButton("By Gringo#2808",function()
  end)
      set:AddButton("Copiar Link Do Discord",function()
      setclipboard("https://discord.gg/xx7zKvFTds")
  end)
  ...
  wait(10)
      ...
      --
      local RenUi = library:AddWindow("MdzHub | King Legacy",Enum.KeyCode.RightControl)
      --
  ...
  game.Players.LocalPlayer:kick("Game Não Suportado!")
  end
